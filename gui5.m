...
% Last Modified by GUIDE v2.5 23-Apr-2016 01:56:42
...
slantletter;
str
setappdata(0,'evalue11',lef);
setappdata(0,'evalue12',str);
setappdata(0,'evalue13',rig);
naive_slant;
r
str
if(r==1)
    F='Initiator, Intense Emotions';
    H=200;
elseif (r==3)
    F='Introvert, Selfish, Inexpressive';
    H=100;
elseif (r==2)
    F='Controlled emotion, Positive, Cool judgement';
    H=300;
end
setappdata(0,'evalue14',H);
setappdata(0,'evalue15',F);
gui6;
